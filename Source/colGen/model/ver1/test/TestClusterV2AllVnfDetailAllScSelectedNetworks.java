...
public class TestClusterV2AllVnfDetailAllScSelectedNetworks {
	public static void runTest() throws Exception{
		//list of file names
		ArrayList<String> listOfGraphs = new ArrayList<String>();
		listOfGraphs.add("cost239.txt");listOfGraphs.add("eon16.txt");listOfGraphs.add("japan.txt");listOfGraphs.add("us24network.txt");
		
		//selected node counts
		ArrayList<Integer> selectedKnodeCount = new ArrayList<Integer>();
		selectedKnodeCount.add(2);selectedKnodeCount.add(3);
		
		//iterate through the graph names
		for(String graphFile : listOfGraphs){
		    ...
		    Graph g = PreProcVer1.makeGraphObject(graphFile);
			...
			for(int kNodeCount : selectedKnodeCount){
		    	...
		    	String filename = "PlotData_Traf_100%_Uniform_K_" + kNodeCount + "_" + graphFile;
