...
public class TestClusterV2CompareUniform {
	public static void runTest() throws Exception{
		...
		String clusterCountBoxPlotFileName = "Compare_Uniform_ClusterCount_BoxPlotData_" + networkName1 + ".txt";
		...
		for(Double trafPrcnt : trafMatPrcnt){
			String bwBoxPlotFileName = "Compare_Bandwidth_Uniform_BoxPlotData_Traf_" + trafPrcnt + "_" + networkName1 + ".txt";
			...
			int minIter = Math.min(bwValues.size(), bwValuesTA.size());
